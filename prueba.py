...
class Ejercicio:
    ...
    def verificar_ejercicio(self, landmarks) -> bool:
        ...
        siguiendo la secuencia de etapas. Utiliza un ThreadPoolExecutor para paralelizar la verificación de los ángulos.
        ...
        def verificar_angulo_hilo(puntos, angulo_inicial, angulo_final):
            nonlocal ejercicio_completado
            ...
            resultados.append(self.stage[puntos])

        # Usar ThreadPoolExecutor para paralelizar la verificación de ángulos
        with ThreadPoolExecutor() as executor:
            for puntos, (angulo_inicial, angulo_final) in self.angulos_objetivo.items():
                executor.submit(verificar_angulo_hilo, puntos,
                                angulo_inicial, angulo_final)

        # Verificar si todos los ángulos han pasado por las etapas "down" y "up"
        return ejercicio_completado and all(stage == "up" for stage in resultados)
